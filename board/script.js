...
const pageChangePassword = document.querySelector("#page-changepassword");
...
// 비밀번호 변경 취소버튼
const cancelChangePasswordBtn = document.querySelector(
